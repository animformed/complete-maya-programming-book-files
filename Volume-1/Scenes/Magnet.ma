...
//Name: Magnet.ma
//Last modified: Fri, Mar 08, 2002 12:14:07 PM
requires maya "4.0";
currentUnit -l centimeter -a degree -t film;
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 21.039973226023026 15.245078235985888 -14.65874978956748 ;
	setAttr ".r" -type "double3" -30.938352729585564 124.59999999999032 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 30.897088642641471;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -2.2204460492503131e-016 1 3.2424449598086076 ;
...
createNode camera -s -n "sideShape" -p "side";
	...
	setAttr ".o" yes;
createNode transform -n "metalObject";
	setAttr ".t" -type "double3" 4.2670664675807917 1 -0.1344257109683904 ;
createNode nurbsSurface -n "metalObjectShape" -p "metalObject";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".tw" yes;
	...
	setAttr ".nufa" 4.5;
	setAttr ".nvfa" 4.5;
createNode transform -n "magnet";
createNode nurbsSurface -n "magnetShape" -p "magnet";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".tw" yes;
...
createNode script -n "sceneConfigurationScriptNode";
	...
	setAttr ".st" 6;
createNode animCurveTL -n "magnet_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 48 0;
createNode animCurveTL -n "magnet_translateY";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 0 48 0;
createNode animCurveTL -n "magnet_translateZ";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 9.9220335311618744 48 -9.8255614494698467;
select -ne :time1;
	setAttr ".o" 1;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
connectAttr "makeNurbCylinder1.os" "metalObjectShape.cr";
connectAttr "magnet_translateX.o" "magnet.tx";
connectAttr "magnet_translateY.o" "magnet.ty";
connectAttr "magnet_translateZ.o" "magnet.tz";
connectAttr "makeNurbSphere1.os" "magnetShape.cr";
...
connectAttr "metalObjectShape.iog" ":initialShadingGroup.dsm" -na;
connectAttr "magnetShape.iog" ":initialShadingGroup.dsm" -na;
// End of Magnet.ma
