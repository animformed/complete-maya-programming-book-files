...
//Name: Primitives.ma
//Last modified: Sun, Jan 27, 2002 03:27:12 PM
requires maya "4.0";
currentUnit -l centimeter -a degree -t film;
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.7639565723051405 5.037989883223819 9.3383996853272446 ;
	setAttr ".r" -type "double3" -22.538352729602376 44.200000000000003 -2.218236588719957e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 13.964434513502271;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" 0.38147909349171849 0.5 0 ;
...
createNode transform -n "nurbsCone1";
	setAttr ".t" -type "double3" -3.872907302625948 0 0 ;
...
createNode transform -n "nurbsCylinder1";
	setAttr ".t" -type "double3" 4.6358654896093849 0 0 ;
