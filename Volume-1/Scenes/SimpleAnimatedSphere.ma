...
//Name: SimpleAnimatedSphere.ma
//Last modified: Thu, Mar 18, 2004 07:03:56 AM
requires maya "4.0";
currentUnit -l centimeter -a degree -t film;
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.3906202476934766 3.292965185770111 4.3906202476934837 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -4.7228827447146885e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.0284217313423873;
...
createNode animCurveTL -n "nurbsSphere1_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -5.3210074003075079 48 1.6412596674104911;
select -ne :time1;
	setAttr ".o" 39;
...
select -ne :hyperGraphLayout;
	...
	setAttr ".ims" 1;
connectAttr "nurbsSphere1_translateX.o" "ball.tx";
...
// End of SimpleAnimatedSphere.ma
