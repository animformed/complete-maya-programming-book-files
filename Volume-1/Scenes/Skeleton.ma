...
//Name: Skeleton.ma
//Last modified: Sat, May 25, 2002 03:45:14 PM
requires maya "4.0";
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.88711222327318984 100 -0.59455107098813276 ;
	setAttr ".r" -type "double3" -89.999999999999986 0 0 ;
createNode camera -s -n "topShape" -p "top";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100;
	setAttr ".ow" 49.775086505190316;
...
createNode joint -n "rootJoint";
	setAttr ".t" -type "double3" 0 1.4192365299303061e-015 -10 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -89.999999999999986 -89.999999999999986 0 ;
createNode joint -n "joint2" -p "rootJoint";
	setAttr ".t" -type "double3" 8 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 179.99999999999997 0 -26.565051177078022 ;
createNode joint -n "joint3" -p "joint2";
	setAttr ".t" -type "double3" 3.9160639382652853 0.96280689456347623 1.8743612320795543e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 -3.5311250384401269e-031 -26.565051177077986 ;
createNode joint -n "joint4" -p "joint3";
	setAttr ".t" -type "double3" 6.1529016654494093 -0.60281246632583341 -1.0742909601522552e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -3.5311250384401269e-031 -6.3611093629270335e-015 
		6.3611093629270335e-015 ;
createNode joint -n "joint5" -p "|rootJoint|joint2|joint3|joint4";
	setAttr ".t" -type "double3" 3.0000000000000022 0 4.4408920985006262e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 7.0622500768802538e-031 -26.565051177077965 ;
createNode joint -n "joint6" -p "|rootJoint|joint2|joint3|joint4|joint5";
	setAttr ".t" -type "double3" 2.2360679774997889 -3.0385816786431356e-064 
		-9.2594004204206383e-065 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -90.000000000000014 1.5902773407317584e-014 
		-116.56505117707796 ;
createNode joint -n "joint7" -p "|rootJoint|joint2|joint3|joint4|joint5";
	setAttr ".t" -type "double3" 1.3416407864998732 -1.7888543819998306 -7.6850986491107769e-017 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.3495751085180491e-014 3.4210673834596455e-031 
		8.0581631396181881e-047 ;
createNode joint -n "joint16" -p "joint2";
	setAttr ".t" -type "double3" 1.5793884781395613 -3.7105356739991038 -1.3000697924282707e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 0 0 153.434948822922 ;
createNode joint -n "joint4" -p "joint16";
	setAttr ".t" -type "double3" -6.1529099999999985 0.60281000000000029 -1.6198615838680114e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
createNode joint -n "joint5" -p "|rootJoint|joint2|joint16|joint4";
	setAttr ".t" -type "double3" -3.0000399999999985 -4.4408920985006262e-016 
		-4.4409951470057842e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 -1.1451769495135232e-014 -26.565051177077994 ;
createNode joint -n "joint6" -p "|rootJoint|joint2|joint16|joint4|joint5";
	setAttr ".t" -type "double3" -2.2360679774997889 4.4408920985006262e-016 
		4.4692256834009614e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -89.999999999999972 -2.862499213317166e-014 
		-116.56505117707795 ;
createNode joint -n "joint7" -p "|rootJoint|joint2|joint16|joint4|joint5";
	setAttr ".t" -type "double3" -1.3416407864998736 1.7888543819998315 -3.700776393009675e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.2074182697257325e-006 2.5428036823106414e-030 
		-2.4132799704657078e-022 ;
createNode joint -n "joint8" -p "rootJoint";
...
createNode joint -n "joint9" -p "joint8";
	...
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -1.1045979161330168e-014 -6.3119880921886683e-015 
		150.25511870305778 ;
createNode joint -n "joint10" -p "rootJoint";
	setAttr ".t" -type "double3" 1.0521904670681383 -5.0118383400581914 1.112851664166346e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -1.1855468093728701e-014 -4.6154875784745316e-015 
		-21.271608924047463 ;
createNode joint -n "joint11" -p "joint10";
	setAttr ".t" -type "double3" 6.0529855461118087 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 4.8726627397394519e-016 -1.8172743912768655e-016 
		20.453153462358852 ;
createNode joint -n "joint12" -p "|rootJoint|joint10|joint11";
	setAttr ".t" -type "double3" 6.028739746639693 -6.9388939039072284e-018 
		2.1425970631307999e-033 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 180 -1.7536444387539226e-030 -29.965691064637912 ;
createNode joint -n "joint13" -p "|rootJoint|joint10|joint11|joint12";
	setAttr ".t" -type "double3" 2.3556325557452134 9.8607613152626476e-032 
		-2.7369110631344083e-048 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 -3.5910695281352696e-015 -30.784146526326523 ;
createNode joint -n "joint14" -p "|rootJoint|joint10|joint11|joint12";
	setAttr ".t" -type "double3" 1.2616368148545214 -2.004609461905468 2.3902009987357776e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -7.0164775638926574e-015 -1.9223677231032576e-030 
		-1.0801530735195109e-014 ;
createNode joint -n "joint15" -p "rootJoint";
	setAttr ".t" -type "double3" 1.0521900000000006 5.0118400000000003 -1.1128485626777751e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 4.9149509061990909e-014 180 21.271608924047438 ;
createNode joint -n "joint11" -p "joint15";
	setAttr ".t" -type "double3" -6.0529834529427475 1.1381631903617517e-006 
		1.7164572702367117e-015 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" 1.2515939484014907e-015 6.9376011714198798e-015 
		20.453153462358856 ;
createNode joint -n "joint12" -p "|rootJoint|joint15|joint11";
	setAttr ".t" -type "double3" -6.028744996179741 -6.1422304158398333e-006 
		7.2998320321372417e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 1.9942591986306273e-014 -29.96569106463792 ;
createNode joint -n "joint13" -p "|rootJoint|joint15|joint11|joint12";
	setAttr ".t" -type "double3" -2.3556372407037429 -3.1073885606858198e-006 
		-8.1991237012980214e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".jo" -type "double3" -180 -1.372059179643976e-014 -30.784146526326548 ;
createNode joint -n "joint14" -p "|rootJoint|joint15|joint11|joint12";
	setAttr ".t" -type "double3" -1.2616341206698882 2.0046068875621259 -4.448973320196752e-016 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
...
select -ne :ikSystem;
	setAttr -s 3 ".sol";
connectAttr "rootJoint.s" "joint2.is";
connectAttr "joint2.s" "joint3.is";
connectAttr "joint3.s" "|rootJoint|joint2|joint3|joint4.is";
connectAttr "|rootJoint|joint2|joint3|joint4.s" "|rootJoint|joint2|joint3|joint4|joint5.is"
		;
connectAttr "|rootJoint|joint2|joint3|joint4|joint5.s" "|rootJoint|joint2|joint3|joint4|joint5|joint6.is"
		;
connectAttr "|rootJoint|joint2|joint3|joint4|joint5.s" "|rootJoint|joint2|joint3|joint4|joint5|joint7.is"
		;
connectAttr "joint2.s" "joint16.is";
connectAttr "joint16.s" "|rootJoint|joint2|joint16|joint4.is";
connectAttr "|rootJoint|joint2|joint16|joint4.s" "|rootJoint|joint2|joint16|joint4|joint5.is"
		;
connectAttr "|rootJoint|joint2|joint16|joint4|joint5.s" "|rootJoint|joint2|joint16|joint4|joint5|joint6.is"
		;
connectAttr "|rootJoint|joint2|joint16|joint4|joint5.s" "|rootJoint|joint2|joint16|joint4|joint5|joint7.is"
		;
connectAttr "rootJoint.s" "joint8.is";
connectAttr "joint8.s" "joint9.is";
connectAttr "rootJoint.s" "joint10.is";
connectAttr "joint10.s" "|rootJoint|joint10|joint11.is";
connectAttr "|rootJoint|joint10|joint11.s" "|rootJoint|joint10|joint11|joint12.is"
		;
connectAttr "|rootJoint|joint10|joint11|joint12.s" "|rootJoint|joint10|joint11|joint12|joint13.is"
		;
connectAttr "|rootJoint|joint10|joint11|joint12.s" "|rootJoint|joint10|joint11|joint12|joint14.is"
		;
connectAttr "rootJoint.s" "joint15.is";
connectAttr "joint15.s" "|rootJoint|joint15|joint11.is";
connectAttr "|rootJoint|joint15|joint11.s" "|rootJoint|joint15|joint11|joint12.is"
		;
connectAttr "|rootJoint|joint15|joint11|joint12.s" "|rootJoint|joint15|joint11|joint12|joint13.is"
		;
connectAttr "|rootJoint|joint15|joint11|joint12.s" "|rootJoint|joint15|joint11|joint12|joint14.is"
		;
