...
//Name: Swirl.ma
//Last modified: Mon, Mar 04, 2002 03:10:04 PM
requires maya "4.0";
currentUnit -l centimeter -a degree -t film;
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 8.0304789727268844 6.5113793477643842 5.0871914260845603 ;
	setAttr ".r" -type "double3" -36.93835272960245 56.600000000000058 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 11.509932858190961;
...
createNode transform -n "nurbsPlane1";
	setAttr ".t" -type "double3" 0 0.066766583101945776 0 ;
