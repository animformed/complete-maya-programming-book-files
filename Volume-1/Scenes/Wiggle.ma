...
//Name: Wiggle.ma
//Last modified: Fri, Mar 08, 2002 12:46:43 PM
requires maya "4.0";
currentUnit -l centimeter -a degree -t film;
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.233490838798879 5.9945848864008067 22.085903117199965 ;
	setAttr ".r" -type "double3" -14.738352729602418 8.999999999999984 -2.012625434777238e-016 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 24.124039210097148;
...
createNode animCurveTL -n "ball_translateX";
	setAttr ".tan" 9;
	setAttr ".wgt" no;
	setAttr -s 2 ".ktv[0:1]"  1 -7.9278585292921679 48 9.6497445535500166;
