...
//Name: BoxMeshes.ma
//Last modified: Tue, Mar 30, 2004 12:26:03 PM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.8914142555704219 2.2898017072414225 0.93384989080466629 ;
	setAttr ".r" -type "double3" -22.538352729601989 55.80000000000026 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 7.2814966155170655;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -2.185652518968888 0 -2.2276136056510296 ;
...
createNode transform -n "box";
	...
	setAttr ".t" -type "double3" -0.32341640355190382 0 -1.9538865562888481 ;
...
createNode transform -n "box1";
	...
	addAttr -ci true -sn "mieg" -ln "miExportGeoShader" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "migs" -ln "miGeoShader" -bt "UNKN" -at "message";
	setAttr ".t" -type "double3" -0.32341640355190382 0 -3.9759125862097684 ;
...
connectAttr "deleteComponent1.og" "boxShape.i";
