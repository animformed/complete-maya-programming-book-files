...
//Name: ConeAndSphereMeshTextured.ma
//Last modified: Fri, Apr 02, 2004 02:05:08 PM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.7489044992342437 4.3100473699205182 -5.9423162244889376 ;
	setAttr ".r" -type "double3" -30.938352729444549 510.99999999926604 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 8.3863932262067031;
...
createNode transform -n "cone";
	...
	addAttr -ci true -sn "mieg" -ln "miExportGeoShader" -bt "UNKN" -min 0 -max 
		1 -at "bool";
	addAttr -ci true -sn "migs" -ln "miGeoShader" -bt "UNKN" -at "message";
	setAttr ".t" -type "double3" 2.5932440927968665 0.73339695572753483 0 ;
...
connectAttr "polySphere1.out" "sphereShape.i";
...
connectAttr "coneShape.iog" ":initialShadingGroup.dsm" -na;
// End of ConeAndSphereMeshTextured.ma
