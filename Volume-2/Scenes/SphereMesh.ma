...
//Name: SphereMesh.ma
//Last modified: Mon, Apr 26, 2004 09:14:17 AM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.1184108512520026 2.4235778564352857 -4.4613628906427856 ;
	setAttr ".r" -type "double3" -26.138352729446936 514.59999999927152 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 5.5013773732503308;
...
createNode mesh -n "sphereShape" -p "sphere";
	...
	setAttr -s 17 ".uvst[0].uvsp[0:16]" -type "float2" 0 0.25 0.25 
		0.25 0.5 0.25 0.75 0.25 1 0.25 0 0.5 0.25 0.5 0.5 0.5 0.75 0.5 1 0.5 0 0.75 
		0.25 0.75 0.5 0.75 0.75 0.75 1 0.75 0.5 0 0.5 1;
	setAttr ".cuvs" -type "string" "map1";
	setAttr -s 14 ".vt[0:13]"  9.2725848e-008 -0.70710677 -0.70710677 
		-0.70710677 -0.70710677 -6.1817239e-008 -3.090862e-008 -0.70710677 0.70710677 
		0.70710677 -0.70710677 0 1.3113416e-007 0 -1 -1 0 -8.7422777e-008 -4.3711388e-008 
		0 1 1 0 0 9.2725848e-008 0.70710677 -0.70710677 -0.70710677 0.70710677 -6.1817239e-008 
		-3.090862e-008 0.70710677 0.70710677 0.70710677 0.70710677 0 0 -1 0 0 1 0;
	setAttr -s 28 ".ed[0:27]"  0 1 0 1 2 
		0 2 3 0 3 0 0 4 5 0 5 
		6 0 6 7 0 7 4 0 8 9 0 
		9 10 0 10 11 0 11 8 0 0 4 
		0 1 5 0 2 6 0 3 7 0 4 
		8 0 5 9 0 6 10 0 7 11 0 
		12 0 0 12 1 0 12 2 0 12 3 
		0 8 13 0 9 13 0 10 13 0 11 
		13 0;
