...
//Name: SphereNurbs.ma
//Last modified: Fri, Jun 18, 2004 02:08:23 PM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.8656456721659076 2.8992342541244334 3.8656456721659112 ;
	setAttr ".r" -type "double3" -27.938352729602379 44.999999999999972 -4.7228827447146885e-014 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 6.1880523741932318;
...
createNode script -n "sceneConfigurationScriptNode";
	setAttr ".b" -type "string" "playbackOptions -min 0 -max 130 -ast 0 -aet 156 ";
	setAttr ".st" 6;
select -ne :time1;
	setAttr ".o" 0;
...
connectAttr "makeNurbSphere1.os" "sphereShape.cr";
