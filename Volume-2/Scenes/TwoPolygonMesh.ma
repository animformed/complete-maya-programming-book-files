...
//Name: TwoPolygonMesh.ma
//Last modified: Fri, Mar 26, 2004 04:46:35 PM
requires maya "5.0";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.625454144556266 5.4197386943170072 0.80590962998163196 ;
	setAttr ".r" -type "double3" -32.138352729605657 50.200000000000806 2.4843825082034418e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 10.188139290817526;
	setAttr ".imn" -type "string" "persp";
	setAttr ".den" -type "string" "persp_depth";
	setAttr ".man" -type "string" "persp_mask";
	setAttr ".tp" -type "double3" -5.0025049125239844 0 -4.7162976671134942 ;
...
createNode transform -n "square";
	...
	setAttr ".t" -type "double3" -5.0025049125239844 0 -4.7162976671134942 ;
createNode mesh -n "squareShape" -p "square";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr -s 2 ".uvst";
...
connectAttr "createUVSet1.og" "squareShape.i";
...
connectAttr "polyPlane1.out" "createUVSet1.ig";
connectAttr "lightLinker1.msg" ":lightList1.ln" -na;
connectAttr "squareShape.iog" ":initialShadingGroup.dsm" -na;
// End of TwoPolygonMesh.ma
